...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(
        registerFailure(err.response?.data?.message || "Ошибка регистрации"),
      );
    }
  };
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="form-group">
              ...
              <div className="role-selector">
                <label
                  className={`role-option ${formData.role === "customer" ? "role-option-active" : ""}`}
                >
                  <input
                    type="radio"
                    name="role"
                ...
                <label
                  className={`role-option ${formData.role === "freelancer" ? "role-option-active" : ""}`}
                >
                  <input
                    type="radio"
                    name="role"
